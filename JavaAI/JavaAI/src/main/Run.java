...
public class Run {
	public static void main(String[] args) {
		...
		*]*/
		...
		Ann ann = new Ann(input, hidden, false, 5e-2f);
		ann.printSummary();
		...
		for(int i = 0; i< 2; i++) {
			trainSet[i] = new Tensor(new Shape(16000, 2));
			trainSet[i].init();
		}
		...
		ann.train(trainSet[0], trainSet[1], 15, 32);
